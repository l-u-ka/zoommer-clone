...
export default function PurchaseHistory() {
  ...
  return (
    <div>
        ...
        {(!boughtProductsLoading && boughtProducts.length === 0) && <div><p className='firago-medium text-black-08 dark:text-dark-black-8 text-sm leading-[17px]'><FormattedMessage id='purchase.history.empty'/></p></div>}
