    ...
    <>
      <div className='flex items-center relative'>
          ...
          <div onFocus={showModal} ref={modalRef}>
            <input ref={searchElement} type="text" placeholder={formatMessage({id: 'search'})} className='py-[12px] pl-[40px] pr-5 w-[460px] border-solid border rounded-xl text-sm font-firago font-normal border-orange-primary dark:bg-gray-primary'/>
