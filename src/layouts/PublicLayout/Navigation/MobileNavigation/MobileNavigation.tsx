...
export default function MobileNavigation() {
  ...
  return (
    <div className="grid grid-cols-3 lg:hidden w-full bg-light-theme-bg dark:bg-[rgba(20,20,20)] fixed left-0 bottom-0 z-10 py-4 border-t border-solid border-b-0 border-x-0 border-white-600">
      ...
      <div className="flex justify-center col-span-1 relative" onClick={() => handleNavigation('/cart')}>
        <div className="inline-flex justify-center items-center flex-col cursor-pointer">
        ...
        {cartItems.length >=1 && <div className="absolute bg-orange-main w-4 h-4 rounded-[50%] top-[-8px] right-24 flex justify-center items-center"><p className="text-white firago-medium text-[10px] leading-[14px]">{cartItems.length}</p></div>}
      </div>
    </div>
  )
}
