    ...
    return <ConfigProvider theme={modalStyle}>
        <Modal open={modalOpen} onCancel={closeModal} maskClosable={false} footer={false} className="max-w-[400px]" closeIcon={<img className="relative top-[-8px] w-auto" src={closeIcon} alt="modal close icon"/>}>
            <div>
                ...
                <h4 className="mt-[40px] mb-[20px] firago-semibold text-base leading-[19px] text-center text-black-main dark:text-white"><FormattedMessage id="logout.sure"/></h4>
                <h4 className="firago-semibold text-base leading-[19px] text-center text-black-06 dark:text-white-600"><FormattedMessage id="information.might.lost"/></h4>
