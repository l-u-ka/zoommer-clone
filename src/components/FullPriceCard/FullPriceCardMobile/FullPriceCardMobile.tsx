...
export default function FullPriceCardMobile({fullPrice, onClick}: {fullPrice: number, onClick: ()=> void}) {
  ...
  return (
    <div className='fixed left-0 bottom-[70px] w-full bg-white-400 dark:bg-[#1f1f1f] lg:hidden p-5 shadow-xl flex justify-between shadow-top'>
        <div className="flex flex-col justify-between">
            <h3 className="firago-medium text-sm leading-[17px] text-black dark:text-white-400"><FormattedMessage id="full.price"/></h3>
